# Generated by Django 4.0.2 on 2022-03-09 09:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_granted_by', models.ForeignKey(blank=True, help_text='دسترسی به این کاربر آخرین بار توسط چه کسی داده شده است.', null=True, on_delete=models.CASCADE, related_name='user_access_granted_by', to=settings.AUTH_USER_MODEL)),
                ('banned_by', models.ForeignKey(blank=True, help_text='یوزر توسط چه کسی بن شده', null=True, on_delete=models.CASCADE, related_name='user_banned_by', to=settings.AUTH_USER_MODEL)),
